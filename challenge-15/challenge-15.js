(function() {
  ...
  */
  ...
  var pessoa1 = new Person("pessoa", "01", 25);
  var pessoa2 = new Person("pessoa", "02", 27);
  var pessoa3 = new Person("pessoa", "02", 29);
  ...
  */
  ...
  pessoa1.addAge(10);
  console.log(
    pessoa1.getFullName() + " agora tem " + pessoa1.getAge() + " anos."
  );

  pessoa2.addAge(5);
  console.log(
    pessoa2.getFullName() + " agora tem " + pessoa2.getAge() + " anos."
  );

  pessoa3.addAge(100);
  console.log(
    pessoa3.getFullName() + " agora tem " + pessoa3.getAge() + " anos."
  );
  // ?
})();
