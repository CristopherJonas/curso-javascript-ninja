(function() {
  ...
  */
  ...
  text = text.replace(/Manuel Marques de Sousa/, "Cristopher Jonas de Faria");
  console.log(text);
  ...
  */
  ...
  text = text.replace(/brasileiro/, "alfenense");
  console.log(text);
  ...
  */
  ...
  var regDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/;
  console.log(regDate);
  ...
  */
  ...
  console.log(text.replace(regDate, replaceDate));
})();
