(function() {
  ...
  */
  ...
  var myRegex = /(\d{3})(\d{3})(\d{3})(\d{2})/;
  console.log("04921434211".replace(myRegex, "$1.$2.$3-$4"));

  console.log("21045852205".replace(myRegex, "$1.$2.$3-$4"));

  myRegex = /(\d{3})(\d{3})(\d{3})(\d{2})/.exec("73550079422");
  console.log(
    myRegex[1] + "." + myRegex[2] + "." + myRegex[3] + "-" + myRegex[4]
  );

  myRegex = /(\d{3})(\d{3})(\d{3})(\d{2})/.exec("10112313132");
  console.log(
    myRegex[1] + "." + myRegex[2] + "." + myRegex[3] + "-" + myRegex[4]
  );
  ...
  */
  ...
  var pattern = /ju[nl]ho/g;
  console.log(
    "Os meses de janeiro, junho e julho começam com a letra j.".match(pattern)
  );
  /*
